...
- (void)requestStarted
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ASIHttpRequestDidStartNotificationName object:self];
#endif
...
{
#ifdef ASI_DEBUG_LOG
    [[NSNotificationCenter defaultCenter] postNotificationName:ASIHttpRequestDidFinishNotificationName object:self];
#endif
