...
//add by LiHaozhen
#ifndef _ASI_NOTIFICATION_
#define _ASI_NOTIFICATION_
static NSString *const ASIHttpRequestDidStartNotificationName = @"ASIHttpRequestDidStartNotificationName";
static NSString *const ASIHttpRequestDidFinishNotificationName = @"ASIHttpRequestDidFinishNotificationName";
#endif
//static NSString *const ASIHttpRequestDidFailNotificationName = @"ASIHttpRequestDidFailNotificationName";
